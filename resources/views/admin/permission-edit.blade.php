...
$aButtons = [
	[
		'form' => 'DELETE|' . route('admin-permission.destroy', $iRecordId),
		'style' => [
			['py-2', 'py-1'],
...
/*	[
		...
		'text' => 'Roles',
		'href' => route('admin-permission.roles', $iRecordId)
	],
	[
		'style' => [
			['py-2', 'py-1'],
		...
		'text' => 'Users',
		'href' => route('admin-permission.users', $iRecordId)
	],*/
];
...
<div class="max-w-7xl w-full shadow-xl rounded-md px-4 py-8">
	<x-form-messages />
	<form method="POST" action="{{ route('admin-permission.update', $iRecordId) }}">
		@csrf
		@method('PUT')
